...
import { index as getItems } from '../../services/items.service';
import { index as getPoints } from '../../services/points.service';
...
const Points = () => {
    ...
    const handleNavigationToDetail = (id: number) => navigation.navigate('Detail', { point_id: id });
    ...
    useEffect(() => {
        ...
        getPoints(city, uf, selectedItems)
            .then(setPoints)
    }, [selectedItems]);
